...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        new_branches = []
        for b in branches(t):
            new_branches = new_branches + [ sprout_leaves(b, leaves) ]
...
def add_trees(t1, t2):
    ...
    #     b1, b2 = branches(t1)[index], branches(t2)[index]
    #     new_branches = add_trees(b1, b2)
    #     result_branches = result_branches + [ new_branches ]
    #     index += 1
    # result_branches += branches(t1)[index:]
    # result_branches += branches(t2)[index:]
